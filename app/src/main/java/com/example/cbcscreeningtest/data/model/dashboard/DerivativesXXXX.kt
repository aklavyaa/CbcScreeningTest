...
data class DerivativesXXXX(
    ...
    val original300: Original300XX,
    @SerializedName("original_620")
    val original620: Original620XX,
    @SerializedName("square_140")
    val square140: Square140XXXX,
    @SerializedName("square_220")
    val square220: Square220XX,
    @SerializedName("square_60")
    val square60: Square60XX,
