...
data class DerivativesXXXXXXX(
    ...
    val original300: Original300XXX,
    @SerializedName("original_620")
    val original620: Original620XXX,
    @SerializedName("square_140")
    val square140: Square140XXXXXXX,
    @SerializedName("square_220")
    val square220: Square220XXX,
    @SerializedName("square_60")
    val square60: Square60XXX,
